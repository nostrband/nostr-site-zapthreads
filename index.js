var NostrContent = (function (exports) {
  ...
  >
    ...
    function getNostrMeta(metaNostrName) {
        const metas = document.getElementsByTagName('meta');
        // @ts-ignore
        for (const meta of metas) {
            const name = meta.getAttribute('name') || meta.getAttribute('property');
            if (name !== 'nostr:' + metaNostrName)
                continue;
    ...
    async function publishReaction(emoji) {
    ...
    async function publishHighlight(text, comment) {
        const [id, addr] = getIdAddr();
        const author = getAuthorPubkey();
        console.log('id', id, 'addr', addr, 'author', author);
        if (!id && !addr)
    ...
    let ModalApps = class ModalApps extends s {
        ...
        async loadData() {
            ...
            try {
                ...
                if (!meta)
                    throw new Error('No nostr id meta');
    ...
    __decorate([
        n()
    ], ModalApps.prototype, "idParam", void 0);
    __decorate([
        n()
  ...
  ></path>
    ...
    let Reactions = class Reactions extends s {
        ...
        async loadData() {
            ...
            let pubkey = '';
            if (this.npub)
                pubkey = nostrSite.nostrTools.nip19.decode(this.npub).data;
    ...
    __decorate([
        n()
    ], Reactions.prototype, "npub", void 0);
    __decorate([
        n()
    ...
    ], exports.NostrContentCta.prototype, "npub", void 0);
    __decorate([
        r()
